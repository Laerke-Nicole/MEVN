      ...
      <div class="register-block">
        ...
        <dialog ref="registerDialog">
          <form class="flex flex-wrap">
            ...
            <button class="bg-[#10B981] text-white p-2 rounded hover:bg-[#059669] w-full mt-4" @click="registerUser(name, email, password)">Register</button> <!-- Register button -->
          </form>
          <button class="bg-red-600 text-white p-2 rounded hover:bg-red-700 w-full mt-2" @click.prevent="toggleRegisterDialog">Close</button> <!-- Close button -->
        </dialog>
      </div>
    </div>
  </div>
